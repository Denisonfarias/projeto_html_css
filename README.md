...
Tamanho de tela	O que muda	Referência no CSS
Mobile (<640px)	Grid de cards vira 1 coluna	—
Tablet (640-1023px)	Grid vira 2 colunas	styles.css:283-287
Desktop (≥1024px)	Grid vira 3 colunas	styles.css:289-293
Mobile (<720px)	Navbar muda layout, Login/Cadastro somem	styles.css:623-651
Tablet+ (≥768px)	Cards da Sobre/Contato viram 3 colunas	styles.css:617-621
🎬 ANIMAÇÕES

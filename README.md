...
Mapeamento completo de estrutura, estilos e lógica do projeto.

* **Squad:** Desenvolvimento / Produto
* **Responsável:** Documentação do Sistema
* **Data Alteração:** 2026-06-18
...
Quem desenha os cards na tela: função renderGrid() em script.js:358-401. Ela se encarrega de:Filtrar os venues pela categoria ativaFiltrar pela busca textualGerar o HTML dinâmico de cada cardMapeamento de Estilos do CardClasse / ElementoDescrição e ComportamentoLinhas de Referência.gridDefine que vira 1, 2 ou 3 colunas conforme o tamanho da telastyles.css:283-293.cardFundo branco, sombra, animação ao passar o mouse (hover)styles.css:296-311.badgePílula azul com a categoria (canto superior esquerdo)styles.css:330-340.ratingNota com estrela (canto superior direito)styles.css:342-355.card-priceOs "R$" amarelos de nível de preçostyles.css:378-382Para adicionar um novo rolê: copie um objeto de venues em script.js, modifique os dados e garanta um id único.📄 PÁGINA "SOBRE" (sobre.html)Hero da página — sobre.html:34-45 (mesma estrutura do home, com imagem diferente)Bloco "Nossa proposta" — sobre.html:49-64:HTML<section class="about-section">
